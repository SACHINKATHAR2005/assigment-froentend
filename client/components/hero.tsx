        ...
        <section className="w-full bg-[#FAFAFA] py-12 md:py-20">
            <div className="w-full max-w-[1440px] mx-auto px-6 md:px-12 flex flex-col md:flex-row items-center justify-between gap-12">
                ...
                <div className="w-full md:w-1/2 flex flex-col items-start text-left">
                    ...
                    <button suppressHydrationWarning className="bg-[#2B7CD3] text-white px-10 py-4 rounded-full text-lg font-semibold hover:bg-blue-700 transition duration-300 shadow-lg cursor-pointer font-sans">
                        Shop Now
                    </button>
                </div>
